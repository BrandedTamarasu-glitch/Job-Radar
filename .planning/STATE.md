...
**Last activity:** 2026-05-15 — shipped v2.6.0 for completed Product Iteration K-O, completed Sprint P dashboard next steps, completed Sprint Q search comparison recaps, and continued Sprint R with Applications follow-up queue filters plus a quick Complete action for queued follow-ups.
