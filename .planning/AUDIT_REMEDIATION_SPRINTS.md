...
- Settings maintenance cache/app-data/dismissed-review feedback, cache-clear action status, dismissed-review cleanup action status, and local diagnostics text composition now live in `job_radar/gui/maintenance_view_model.py`.
...
- Latest validation: `1178 passed, 8 skipped`.
