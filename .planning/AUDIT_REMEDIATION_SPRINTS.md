...
- `job_radar/source_mappers.py` now contains the Adzuna, Authentic Jobs, and JSearch API response mappers while `job_radar/sources.py` preserves the existing mapper import paths.
...
- Latest validation: `1166 passed, 8 skipped`.
