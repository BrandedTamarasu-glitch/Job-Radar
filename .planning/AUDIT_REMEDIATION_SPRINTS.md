...
- `job_radar/source_api_fetchers.py` now contains the Adzuna, Authentic Jobs, JSearch, SerpAPI, and Jobicy API fetchers while `job_radar/sources.py` preserves existing patch-compatible fetcher import paths and registry wiring.
