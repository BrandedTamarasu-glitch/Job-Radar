...
- `job_radar/source_mappers.py` now contains the Adzuna, Authentic Jobs, JSearch, and USAJobs API response mappers while `job_radar/sources.py` preserves the existing mapper import paths.
...
- Latest validation: `1168 passed, 8 skipped`.
