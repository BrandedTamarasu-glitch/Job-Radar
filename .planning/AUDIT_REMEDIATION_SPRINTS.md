...
- Search idle profile-readiness guidance and recent/saved search panel construction now live in `job_radar/gui/search_panel.py`.
...
- Latest validation: `1085 passed, 8 skipped`.
