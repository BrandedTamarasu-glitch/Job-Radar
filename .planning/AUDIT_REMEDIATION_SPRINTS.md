...
- Settings storage maintenance, diagnostics, Jobicy public-source status, and JSearch setup tip construction now live in `job_radar/gui/settings_panel.py`.
- Latest validation: `1091 passed, 8 skipped`.
