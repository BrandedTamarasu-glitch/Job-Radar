...
- Settings maintenance cache/app-data/dismissed-review feedback, dismissed-review cleanup action status, and local diagnostics text composition now live in `job_radar/gui/maintenance_view_model.py`.
...
- Latest validation: `1177 passed, 8 skipped`.
