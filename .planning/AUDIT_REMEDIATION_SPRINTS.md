...
- `job_radar/source_scrapers.py` now contains the HN Hiring, RemoteOK, and We Work Remotely scraper fetchers while `job_radar/sources.py` preserves existing patch-compatible fetcher import paths and registry wiring.
