...
- Search idle profile-readiness guidance, recent/saved search panels, and search progress panel construction now live in `job_radar/gui/search_panel.py`.
...
- Latest validation: `1086 passed, 8 skipped`.
