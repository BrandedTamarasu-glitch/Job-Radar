...
- Search idle profile-readiness guidance, recent/saved search panels, search progress, search completion, and search error panel construction now live in `job_radar/gui/search_panel.py`.
...
- Latest validation: `1088 passed, 8 skipped`.
