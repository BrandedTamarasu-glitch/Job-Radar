...
Status: in progress. Settings source diagnostics now label source health, prioritize unhealthy sources above slow-but-working sources, and include recommended actions for failed, warning-heavy, slow, and healthy sources.
