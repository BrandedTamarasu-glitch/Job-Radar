...
The project includes a comprehensive test suite with 816 automated tests:
...
- Saved searches (10 tests) - validates recent search storage, named search storage, config normalization, deduplication, deletion, history caps, and labels
