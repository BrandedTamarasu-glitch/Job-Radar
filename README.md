...
The project includes a comprehensive test suite with 813 automated tests:
...
- GUI onboarding (12 tests) - validates first-run demo report access, welcome/search feedback handling, Search tab profile-readiness guidance, profile-form field hints, profile-aware zero-result guidance wiring, non-blocking recent-search recording, and recent-search reapply controls
