...
The project includes a comprehensive test suite with 893 automated tests:
...
- Data portability (3 tests) - validates portable app-data export bundles and manifests
