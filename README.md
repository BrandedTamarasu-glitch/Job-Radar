...
The project includes a comprehensive test suite with 790 automated tests:
...
- GUI onboarding (2 tests) - validates first-run demo report access and welcome/search feedback handling
