...
The project includes a comprehensive test suite with 740 automated tests:
...
- API integration (52 tests) - validates all 11 API sources, mappers, rate limiting, source selection, deduplication
...
- GUI search summary (17 tests) - validates search completion, source warnings, cache controls, GUI preset application, source selection, company filters, must-have skill filters, location strictness, and freshness presets
