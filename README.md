...
The project includes a comprehensive test suite with 809 automated tests:
...
- Saved searches (6 tests) - validates recent search storage, config normalization, deduplication, history caps, and labels
