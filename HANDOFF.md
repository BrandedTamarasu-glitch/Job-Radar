...
- Branch: `main`
- Git status after latest slice: clean, `main...origin/main [ahead 103]`
- Last full validation: `1177 passed, 8 skipped`
- Do not push unless explicitly asked. The 103 local commits after the last push are still local.

## Latest Local Commits

```text
(current) refactor: centralize dismissed review cleanup
...
2314 job_radar/gui/main_window.py
 ...
 303 job_radar/gui/maintenance_view_model.py
